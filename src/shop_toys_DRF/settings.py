"""
Django settings for shop_toys_DRF project.
...
SECRET_KEY = 'django-insecure-@t_^m=%$3u6!*hxbzlvk@t+q68@dn(1l%9-4-eu&e#52h@n1@6'
...
WSGI_APPLICATION = 'shop_toys_DRF.wsgi.application'
